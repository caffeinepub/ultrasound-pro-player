...
export function Playlist({ files, currentIndex, onSelect, onRemove }: Props) {
  if (files.length === 0) {
    return (
  ...
  return (
    <div className="flex flex-col gap-1">
      <h3 className="font-orbitron font-bold text-sm uppercase tracking-widest mb-2" style={{ color: '#FFD700' }}>
        ...
        {files.map((file, index) => (
          <div
            ...
            style={{
              ...
              boxShadow: currentIndex === index ? '0 0 12px rgba(255,215,0,0.2)' : 'none'
            }}
          ...
          >
            ...
            <div
              ...
              style={{ color: currentIndex === index ? '#FFD700' : 'rgba(255,255,255,0.3)' }}
            >
            ...
            <div className="flex-1 min-w-0">
              <p
                ...
                style={{ color: currentIndex === index ? '#FFD700' : 'white' }}
              >
                {file.name}
              </p>
              <p className="font-rajdhani text-xs truncate" style={{ color: 'rgba(255,255,255,0.4)' }}>
                {file.artist}
              </p>
            </div>

            {/* Duration */}
            <span className="font-orbitron text-xs shrink-0" style={{ color: 'rgba(255,255,255,0.4)' }}>
            ...
            <button
              ...
              style={{ color: 'rgba(255,68,68,0.7)', cursor: 'pointer', background: 'none', border: 'none' }}
            >
              <Trash2 size={12} />
            </button>
          </div>
